...
export const metadata: Metadata = {
  title: "Contact us",
  description:
    "Get in touch with Staylio. WhatsApp Ali Hassan, our Direct Bookings lead, on +44 7304 353 640. Real people, no call centres, no ticket numbers.",
};
      ...
      <div className="mt-10 rounded-2xl border border-stone-200 bg-stone-50 p-6 sm:p-8">
        ...
        <div className="mt-5 flex flex-wrap items-center gap-3">
          <a
            ...
            aria-label="WhatsApp Ali Hassan on +44 7304 353 640"
          >
            ...
            WhatsApp Ali on +44 7304 353 640
          </a>
          <a
