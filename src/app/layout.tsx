...
export const metadata: Metadata = {
  ...
  // Tokens live in Vercel env vars
  // (NEXT_PUBLIC_GOOGLE_VERIFICATION, NEXT_PUBLIC_BING_VERIFICATION)
  // — generated by Kris in search.google.com/search-console + bing.com/webmasters.
  // The HTML-tag verification method is the easiest because we don't need DNS access to ship.
  verification: {
