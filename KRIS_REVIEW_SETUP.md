...
_Built 5 Jun 2026. Owners: Kris (director / verification), the operator (operations / DNS / site code), Sofia (email drafts), Iris (review routing)._
...
| **Phone number on site** | Stale `+44 7375 621453` everywhere | Replace with locked `+44 7304 353 640` (separate task) |
...
3. **Configure profile** — paste verbatim:
   ...
   - Bio:
     > Independent London serviced apartment operator. 40+ fully equipped apartments across seven Central London neighbourhoods — Regent's Park & Marylebone, Old Street & Shoreditch, Kensington & Hammersmith, Fitzrovia & Mayfair, Barbican & Farringdon, Borough & Pimlico, and Little Venice & Maida Vale. Fortnightly housekeeping. All bills included. Boutique, curated, warm.
...
6. **Add the operator as additional admin** so she can manage between Kris's availability.
7. **Decline paid tier (Lite £200/mo) for now.** Free covers everything needed until review velocity actually stalls.
...
4. **Upload 10+ photos** (Staylio Drive + BOOM media library):
   ...
   - 1 brand logo
   - 1 team / guest-facing photo (Ali / Operations + Kris — humanises the listing)
...
**Don't send until both review links are live + the operator has reviewed the first batch.**
...
## Phase 4 — Routing + reporting (the operator sign-off before wiring)
...
- [ ] Trustpilot login recovered or admin transferred — Kris or the operator has access
...
- `~/.claude/projects/-Users-<owner>/memory/feedback_never_sign_as_staylio_director.md` — Kris is director, not the operator
